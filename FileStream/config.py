...
class Telegram:
    ...
    OWNER_ID = int(env.get('OWNER_ID', '6791744215'))
    ...
    START_PIC = env.get('START_PIC', "https://graph.org/file/68dba08a68df30bef4046.jpg")
    ...
    AUTH_USERS = list(set(int(x) for x in str(env.get("AUTH_USERS", "6791744215")).split()))
